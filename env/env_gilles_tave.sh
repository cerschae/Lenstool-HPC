...
export CFITSIO_ROOT=/users/fgilles/Projects-local/Libs/cfitsio/
export WCSTOOL_ROOT=/users/fgilles/Projects-local/Libs/wcstools-3.9.4/libwcs/
export GSL_ROOT=/users/fgilles/Projects-local/Libs/gsl-2.2/
